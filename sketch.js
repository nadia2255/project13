...
function preload(){
  ...
  // red_balloonImage = preloadImage("red_balloon0.png");
  // red_balloonImage = preloadImage("redballoon0.png");
  // red_balloonImage = preloadImage("red_balloon0");
